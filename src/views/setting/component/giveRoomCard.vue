				...
				<el-row :gutter="35">
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="玩家ID" prop="target">
							<el-input v-model="ruleForm.target" style="width: 200px" placeholder="请输入玩家ID" clearable />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="赠送房卡数量" prop="num">
							<el-input v-model="ruleForm.num" style="width: 200px" placeholder="请输入赠送房卡数量" clearable />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="设置房卡数量" prop="giverRoomCardNum">
							<el-input v-model="ruleForm.giverRoomCardNum" style="width: 200px" placeholder="请输入设置房卡数量" clearable />
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
	...
	ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
		if (isValid) {
			...
			await request.post('/admin/giveRoomCard', {
				...values,
				target: fillPpkId(values.target),
			});
