		...
		<el-dialog v-model="isShowDialog" :title="props.title" :width="500" draggable="">
			<el-form :model="ruleForm" ref="ruleFormRef" size="default" label-width="100px" :rules="rules">
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="子游戏类型" prop="childType">
							<el-select v-model="ruleForm.childType" style="width: 200px" placeholder="请选择子游戏类型" clearable>
								<el-option label="麻将" :value="1"></el-option>
								<el-option label="跑得快" :value="5"></el-option>
								<el-option label="扯旋" :value="6"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
