				...
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="俱乐部ID" prop="clubKey">
							<el-input
								disabled
								v-model="ruleForm.clubKey"
								style="width: 200px"
								placeholder="请输入俱乐部唯一标识"
								clearable
							/>
						</el-form-item>
					</el-col>
					...
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="玩法" prop="childTypes">
							<el-checkbox-group
								v-model="ruleForm.childTypes"
								style="width: 300px"
								placeholder="请选择子游戏类型"
								clearable
							>
...
const openDialog = (data: any) => {
	...
	ruleForm.value.childTypes = data.gameTypes;
