<template>
  <div class="swiper-container">
    <el-dialog v-model="isShowDialog" :title="props.title" :width="500" draggable="">
      <h3 class="mb20 " style="text-align: center;"> <span style="color: red;">{{ row.nickName }}</span></h3>
      <el-form :model="ruleForm" ref="ruleFormRef" size="default" label-width="100px" :rules="rules">
        <el-row :gutter="35">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="俱乐部ID" prop="clubKey">
              <el-input disabled v-model="ruleForm.clubKey" style="width: 200px" placeholder="请输入俱乐部唯一标识" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="筛选时间" style="width: 400px">
              <el-date-picker v-model="time" value-format="x" :picker-options="options" type="datetimerange"
...
const openDialog = (data: any) => {
  row.value = data;
  ruleForm.value.clubKey = data.clubKey;
  console.log(data.clubFreeRoomCardTimes);
  time.value[0] = data.clubFreeRoomCardTimes?.[0] * 1000 || 0;
  time.value[1] = data.clubFreeRoomCardTimes?.[1] * 1000 || 0;
