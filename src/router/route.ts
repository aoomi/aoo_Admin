 ...
 * @returns 返回路由菜单数据
 */
const migratedRoutes: Array<RouteRecordRaw> = [
	{
		path: '/',
		name: '/',
		...
		children: [
			...
			},
			{
				path: '/userIp',
				name: 'userIp',
				component: () => import('/@/views/userList/ip.vue'),
				meta: {
					title: '同IP用户',
					isLink: '',
					isHide: false,
			...
			},
			{
				...
				meta: { title: '业务运营中心', isLink: '', isHide: false, isKeepAlive: true, isAffix: false, isIframe: false, roles: ['admin'], icon: 'iconfont icon-xitongshezhi' },
			},
			{
				path: '/game',
				name: 'game',
				...
				children: [
					...
					},
					{
						path: '/game/info',
						name: 'gameInfo',
						component: () => import('/@/views/game/info.vue'),
						meta: {
							title: '信息管理',
							isLink: '',
							isHide: false,
...

					{
						path: '/roomCard/ct',
						name: 'roomCardct',
						component: () => import('/@/views/roomCard/ct.vue'),
						meta: {
							title: 'CT',
							isLink: '',
							isHide: false,
					...
					},
					{
						path: '/roomCard/lt',
						name: 'roomCardlt',
						component: () => import('/@/views/roomCard/lt.vue'),
						meta: {
							title: 'LT',
							isLink: '',
							isHide: false,
					...
					},
					{
						path: '/roomCard/at',
						name: 'roomCardat',
						component: () => import('/@/views/roomCard/at.vue'),
						meta: {
							title: 'AT',
							isLink: '',
							isHide: false,
					...
					{
						path: '/roomCard/gameLucky',
						name: 'roomCardgameLucky',
						component: () => import('/@/views/roomCard/gameLucky.vue'),
						meta: {
							title: '玩法体验设置',
							isLink: '',
							isHide: false,
			...
			{
				path: '/roomCard/friend',
				name: 'roomCardFriend',
				component: () => import('/@/views/roomCard/friend.vue'),
				meta: {
					title: '俱乐部',
					isLink: '',
					isHide: false,
			...
			},
			{
				...
				children: [
					...
					},
					{
						path: '/club/room',
						name: 'clubRoom',
						component: () => import('/@/views/club/room.vue'),
						meta: {
							title: '俱乐部房间',
							isLink: '',
							isHide: true,
					...
					},
					{
						path: '/club/robot',
						name: 'clubRobot',
						component: () => import('/@/views/club/robot.vue'),
						meta: {
							title: 'AI列表',
							isLink: '',
							isHide: false,
					...
					},
					{
						path: '/club/config',
						name: 'clubConfig',
						component: () => import('/@/views/club/config.vue'),
						meta: {
							title: '配置',
							isLink: '',
							isHide: false,
			...
			},
			{
				path: '/roomCard/card',
				name: 'roomCardCard',
				component: () => import('/@/views/roomCard/card.vue'),
				meta: {
					title: '消耗统计',
					isLink: '',
					isHide: false,
			...
			},
			{
				...
				children: [
					{
						path: '/roomCard/member',
						name: 'roomCardMember',
						component: () => import('/@/views/roomCard/member.vue'),
						meta: {
							title: '成员列表',
							isLink: '',
							isHide: true,
			...
			// 			path: '/dw/fish',
			// 			name: 'dwfish',
			// 			component: () => import('/@/views/dw/fish.vue'),
			// 			meta: {
			// 				title: '捕鱼',
			// 				isLink: '',
			// 				isHide: false,
			...
			// 			path: '/dw/ct',
			// 			name: 'dwct',
			// 			component: () => import('/@/views/dw/line.vue'),
			// 			meta: {
			// 				title: '连线',
			// 				isLink: '',
			// 				isHide: false,
			...
			// 			path: '/dw/lt',
			// 			name: 'dwlt',
			// 			component: () => import('/@/views/dw/people.vue'),
			// 			meta: {
			// 				title: '百人',
			// 				isLink: '',
			// 				isHide: false,
			...
			// 			path: '/dw/tiger',
			// 			name: 'dwtiger',
			// 			component: () => import('/@/views/dw/tiger.vue'),
			// 			meta: {
			// 				title: '老虎机',
			// 				isLink: '',
			// 				isHide: false,
...
// Production exposes only the dedicated control-plane workspace. The historical
// template pages call removed /admin/* handlers or render placeholders, so keeping
// them in the menu created duplicate/broken entry points that could bypass RBAC.
const productionOperations = migratedRoutes[0].children?.find(route => route.path === '/operations');
export const dynamicRoutes: Array<RouteRecordRaw> = import.meta.env.VITE_APP_ENV === 'production'
	? [{ ...migratedRoutes[0], redirect: '/operations', children: productionOperations ? [productionOperations] : [] }]
	: migratedRoutes;
