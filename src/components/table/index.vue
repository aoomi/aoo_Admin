<template>
	<div class="table-container">
		...
		>
			<el-table-column type="selection" :reserve-selection="true" min-width="30" v-if="config.isSelection" />
			<el-table-column type="index" label="序号" min-width="60" v-if="config.isSerialNo" />
			<el-table-column
			...
			<el-table-column label="操作" min-width="100" v-if="config.isOperate">
				<template v-slot="scope">
