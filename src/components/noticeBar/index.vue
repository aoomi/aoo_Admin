...
const onAnimationEnd = () => changeAnimation();
// 监听 animation 动画的结束
const listenerAnimationend = () => {
	noticeBarTextRef.value.addEventListener('animationend', onAnimationEnd, false);
};
// 右侧 icon 图标点击
...
onUnmounted(() => noticeBarTextRef.value?.removeEventListener('animationend', onAnimationEnd, false));
</script>
